    ...
    def export_image(self, path, export_gt=True, print_fps=False):
        ...
        for idx, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="export images"):
            ...
            if self._additional_return:
                ...
                save_img_u8(depth, os.path.join(vis_path, 'depth_{0:05d}'.format(idx) + ".png"))
                #save_img_u8(self.normals[idx] * 0.5 + 0.5, os.path.join(vis_path, 'normal_{0:05d}'.format(idx) + ".png"))
                #save_img_u8(self.depth_normals[idx] * 0.5 + 0.5, os.path.join(vis_path, 'depth_normal_{0:05d}'.format(idx) + ".png"))
